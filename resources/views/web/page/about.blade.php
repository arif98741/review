			...
			<div id="carousel" class="owl-carousel owl-theme">
				...
				<div class="item">
					<a href="#0">
						...
						</div><img src="{{ asset('asset/front/img/2_carousel.jpg') }}" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#0">
						...
						</div><img src="{{ asset('asset/front/img/3_carousel.jpg') }}" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#0">
						...
						</div><img src="{{ asset('asset/front/img/4_carousel.jpg') }}" alt="">
					</a>
				</div>
				<div class="item">
					<a href="#0">
						...
						</div><img src="{{ asset('asset/front/img/5_carousel.jpg') }}" alt="">
					</a>
				</div>
			</div>
			<!-- /carousel -->
