			...
			<div class="col-lg-9">
				<div class="row">
					<div class="col-md-6">
						<article class="blog">
							<figure>
								<a href="blog-post.html"><img src="{{('asset/front/img/blog-1.jpg')}}" alt="">
							...
							<div class="post_info">
								...
								<ul>
									<li>
										<div class="thumb"><img src="{{('asset/front/img/avatar.jpg')}}" alt=""></div> Admin
									</li>
					...
					<div class="col-md-6">
						<article class="blog">
							<figure>
								<a href="blog-post.html"><img src="{{('asset/front/img/blog-2.jpg')}}" alt="">
									<div class="preview"><span>Read more</span></div>
								</a>
							</figure>
							<div class="post_info">
					...
					<div class="col-md-6">
						<article class="blog">
							<figure>
								<a href="blog-post.html"><img src="{{('asset/front/img/blog-3.jpg')}}" alt="">
									<div class="preview"><span>Read more</span></div>
								</a>
							</figure>
							<div class="post_info">
					...
					<div class="col-md-6">
						<article class="blog">
							<figure>
								<a href="blog-post.html"><img src="{{('asset/front/img/blog-4.jpg')}}" alt="">
									<div class="preview"><span>Read more</span></div>
								</a>
							</figure>
							<div class="post_info">
					...
					<div class="col-md-6">
						<article class="blog">
							<figure>
								<a href="blog-post.html"><img src="{{('asset/front/img/blog-5.jpg')}}" alt="">
									<div class="preview"><span>Read more</span></div>
								</a>
							</figure>
							<div class="post_info">
					...
					<div class="col-md-6">
						<article class="blog">
							<figure>
								<a href="blog-post.html"><img src="{{('asset/front/img/blog-6.jpg')}}" alt="">
									<div class="preview"><span>Read more</span></div>
								</a>
							</figure>
							<div class="post_info">
			...
			<aside class="col-lg-3">
				...
				<div class="widget">
					...
					<ul class="comments-list">
						<li>
							<div class="alignleft">
								<a href="#0"><img src="{{('asset/front/img/blog-5.jpg')}}" alt=""></a>
							</div>
						...
						<li>
							<div class="alignleft">
								<a href="#0"><img src="{{('asset/front/img/blog-6.jpg')}}" alt=""></a>
							</div>
							<small>Category - 11.08.2016</small>
							<h3><a href="#" title="">Verear qualisque ex minimum...</a></h3>
						</li>
						<li>
							<div class="alignleft">
								<a href="#0"><img src="{{('asset/front/img/blog-4.jpg')}}" alt=""></a>
							</div>
							<small>Category - 11.08.2016</small>
							<h3><a href="#" title="">Verear qualisque ex minimum...</a></h3>
						</li>
