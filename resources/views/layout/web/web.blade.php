...
<head>
    ...
    <link href="{{asset('asset/front/css/vendors.css')}}" rel="stylesheet"> @stack('extra-css')
    <!-- YOUR CUSTOM CSS -->
...
<body>
    ...
    <div id="page">
        ...
        <header class="header menu_fixed">
            ...
            <ul id="top_menu">
                ...
                <li><a href="#sign-in-dialog" id="sign-in" class="login" title="Sign In" style="color: #000;">Sign
                        In</a>
                </li>
                @elseif(Auth::guard('reviewer')->check())

                <li><a href="{{ url('/reviewer/logout') }}" onclick="event.preventDefault();
					document.getElementById('reviewer-logout-form').submit();" class="login" title="Logout" style="color: #fff;">Logout</a>
                ...
                <li><a href="{{ url('/company/logout') }}" onclick="event.preventDefault();
					document.getElementById('company-logout-form').submit();" class="login" title="Logout" style="color: #fff;">Logout</a>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <ul id="additional_links">
                            ...
                            <li><span>© {{ date('Y') }} ReviewStore</span></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    @php $current = url()->current(); $explode = explode('/', $current); @endphp

    <!-- page -->

    <!-- Sign In Popup -->
    {{-- start --}} @if(end($explode) == 'companies-landing')
        ...
        <form method="POST" action="{{ url('/company/login') }}">
            ...
            <div class="sign-in-wrapper">
                ...
                <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                    <label>Email</label>
                    <input type="email" class="form-control" name="email" value="{{ old('email') }}" autofocus> @if ($errors->has('email'))
                ...
                <div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
                    ...
                    <input type="password" class="form-control" name="password" id="password" placeholder="Password"> @if ($errors->has('password'))
                    <span class="help-block" style="color: red;">
