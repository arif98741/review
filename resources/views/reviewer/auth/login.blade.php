	...
	<div id="login">
		<aside>
			<figure>
			 ...
			 <form class="form-horizontal" role="form" method="POST" action="{{ url('/reviewer/login') }}">
                        {{ csrf_field() }}
				...
				<div class="text-center add_top_10">New to ReviewStore? <strong><a href="{{ url('/reviewer/register') }}">Sign up!</a></strong></div>
			</form>
