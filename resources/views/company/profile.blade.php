				...
				<div class="row">
					<div class="col-lg-8">
						...
						<span class="rating">
							...
							<em>{{ number_format((float)$total_rating, 2, '.', '') }}/5.00 - based on {{ $reviews_data->count() }} reviews</em></span>
						</div>
				...
				<div class="col-lg-8">
					...
					<div class="col-lg-4">
						<div class="box_general company_info">
							...
							<p><strong>Website</strong><br><a href="http://{{ $company->website }}">{{ $company->website }}</a></p>
