    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item">Founder list</li>
        </ol>
      </div>
    </div>
  </div><!-- /.container-fluid -->
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img src="{{ asset('storage/uploads/founder/'.$founder->image) }}" style="width: 100px; height: 100px; border-radius: 100%;" alt=""></td> 
                    <td>
